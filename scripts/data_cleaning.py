...
def read_consul (fn = '/Users/cem_ataman/PycharmProjects/MadridDecidim-Data-Analysis/data/intermediate_data/selected_debate_comments_en.xlsx'):
    df = pd.read_excel(fn, sheet_name='Sheet1', index_col=0, header=0)
    return(df)
...
def make_lower (data):
    clean_text_1 = []
    for i in data.index:
        clean_text_1.append(str(data["body"][i]).lower())
    return (clean_text_1)
...
with open('/Users/cem_ataman/PycharmProjects/MadridDecidim-Data-Analysis/data/intermediate_data/corpus.pkl', 'wb') as f:
    pickle.dump(corpus, f)

x = open("/Users/cem_ataman/PycharmProjects/MadridDecidim-Data-Analysis/data/intermediate_data/final_data.py", "w+")
